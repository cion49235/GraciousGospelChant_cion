package gracious.gospel.cion.activity;
...
import gracious.gospel.cion.R;
import gracious.gospel.cion.adapter.MainAdapter;
import gracious.gospel.cion.data.Favorite_DBopenHelper;
import gracious.gospel.cion.data.Main_Data;
import gracious.gospel.cion.data.Pause_DBOpenHelper;
...
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, OnScrollListener, AdViewListener, CustomPopupListener, InterstitialAdListener{
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "mfgoni21");
...
//		admobNative.destroy();
	...
	private void init_admob_naive(){
		...
		admobNative.setAdUnitId("ca-app-pub-4637651494513698/4116742569");
		nativeContainer.addView(admobNative);
		admobNative.loadAd(adRequest);
	}
	
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("mfgoni21");
